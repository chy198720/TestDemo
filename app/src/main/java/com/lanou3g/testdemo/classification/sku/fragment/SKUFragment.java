package com.lanou3g.testdemo.classification.sku.fragment;
...
import com.lanou3g.testdemo.classification.sku.bean.SKUItemBean;
import com.lanou3g.testdemo.classification.sku.activity.SKURecycleActivity;
import com.lanou3g.testdemo.classification.sku.adapter.SKUAdapter;
import com.lanou3g.testdemo.classification.sku.adapter.SKUItemAdapter;
...
public class SKUFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        tool.getData(URLValues.EDITTEXT, EditBean.class, new NetInterface<EditBean>() {
            @Override
