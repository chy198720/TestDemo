package com.lanou3g.testdemo.classification.strategy.fragment;
...
import com.lanou3g.testdemo.classification.strategy.activity.ColumnActivity;
import com.lanou3g.testdemo.classification.strategy.activity.StrategyItemActivity;
import com.lanou3g.testdemo.classification.strategy.adapter.ExpandAdapter;
import com.lanou3g.testdemo.classification.strategy.adapter.StrategyAdapter;
import com.lanou3g.testdemo.classification.strategy.bean.ExpandBean;
import com.lanou3g.testdemo.classification.strategy.bean.StrategyBean;
import com.lanou3g.testdemo.home.gallery.bean.EditBean;
import com.lanou3g.testdemo.home.gallery.activity.HomeEditActivity;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.edit_strategy:
                startActivity(new Intent(getContext(), HomeEditActivity.class));
                break;
