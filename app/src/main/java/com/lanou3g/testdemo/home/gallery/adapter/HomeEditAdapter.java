...
public class HomeEditAdapter extends BaseAdapter {
    ...
    public void setBoxBeen(EditBean boxBeen) {
        mBoxBeen = boxBeen;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.mEt_text_item.setTextColor(Color.BLACK);
    ...
    class ViewHolder {
        ...
        private final TextView mEt_text_item;

        public ViewHolder(View view) {
            mEt_text_item = (TextView) view.findViewById(R.id.et_text_item);
        }
    }
}
